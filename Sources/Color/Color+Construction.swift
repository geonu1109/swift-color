...
public extension Color {
    /// Wrap any representation, preserving the space it's expressed in.
    init(_ representation: some ColorRepresentation) {
        ...
        default: storage = .custom(representation) // a user-defined space, kept as-is
        }
    }
